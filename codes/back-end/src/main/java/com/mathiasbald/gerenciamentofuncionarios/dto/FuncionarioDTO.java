...
/**
 * FuncionarioDTO: Classe que carrega os dados do funcionário para dentro e fora
 * da API. Responsável também por validar o mesmo
 */
@Data
public class FuncionarioDTO {
    ...
    @Pattern(regexp = "^\\d{11}$", message = "O NIS deve possuir exatamente 11 números")
    private String nis;
